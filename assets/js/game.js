...
console.log( playerInfo.name + " attacked " + enemy.name + " now has " + enemey.health + " health remaining.");
...
//player gets attacked first
    ...
    console.log(enemy.name + " attacked " +  playerInfo.name + ". " + playerInfo.name + " now has " + playerInfo.name + " now has " + playerInfo.health + " health remaining."
    );

    //check player's health
    if (playerInfo.health <= 0) {
        window.alert(playerInfo.name + " has died!");
        // leave while() loop if player i sdead
        break;
    } else {
...
var shop = function () {
   ...
   var shopOptionPrompt = window.prompt(
    ...
    // use switch to carry out actiom
